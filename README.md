...
## Структура проекта
Проект выполнен с использованием технологии ASP.NET Core, так как .NET предполагает собой решения уровня Enterprise, проект в данном решении был декомпозирован на 4 проекта:
